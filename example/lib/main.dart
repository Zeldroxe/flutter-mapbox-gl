...
class _MapsDemoState extends State<MapsDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MapsDemo.ACCESS_TOKEN.isEmpty || MapsDemo.ACCESS_TOKEN.contains("YOUR_TOKEN")
          ...
          children: [
            ...
            "passed into flutter run or add it to args in vscode's launch.json",
              ...
              .map((text) => Padding(
                    ...
                    child: Text(text, textAlign: TextAlign.center, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
                  ))
              .toList(),
        ),
      ),
