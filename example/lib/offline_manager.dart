...
//  LatLng _sourcePosition;
      ...
      case "retrieveDownloadedTileNames":
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            ...
            return AlertDialogWidget(downloadedTiles, offlineMC);
          },
        );
  ...
  showDownloadAlertDialog(BuildContext context) {
    ...
    Widget downloadButton = FlatButton(
      ...
      onPressed: () {
        Navigator.of(context).pop();
        final Map<String, String> args = <String, String>{"downloadName": widget.downloadController.text};
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
...
//    for (String name in names) {
  ...
  Widget build(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Column(mainAxisSize: MainAxisSize.min, children: createColumn(widget.downloadedTiles)),
      actions: [
        deleteButton,
        cancelButton,
        navToButton,
